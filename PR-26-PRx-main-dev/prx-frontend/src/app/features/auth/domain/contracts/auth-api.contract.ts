...
export abstract class AuthApiContract {
  abstract login(data: LoginRequest): Observable<ApiResponseModel<LoginResultModel>>;
  abstract verifyLoginTwoFactor(
  ...
  abstract confirmRegister(data: ConfirmRegisterRequest): Observable<ApiResponseModel<AuthModel>>;
